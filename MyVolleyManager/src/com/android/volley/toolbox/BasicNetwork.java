...
import com.android.volley.base.NetworkError;
import com.android.volley.base.NetworkResponse;
import com.android.volley.base.NoConnectionError;
import com.android.volley.base.Request;
import com.android.volley.base.RetryPolicy;
import com.android.volley.base.ServerError;
import com.android.volley.base.TimeoutError;
import com.android.volley.base.VolleyError;
import com.android.volley.base.VolleyLog;
import com.android.volley.base.Cache.Entry;
        ...
        while(true) {
            ...
            try {
                ...
                if(responseContents != null) {
                    networkResponse=
                        new NetworkResponse(statusCode, responseContents, responseHeaders, false, SystemClock.elapsedRealtime()
                            - requestStart);
    ...
    private void logSlowRequests(long requestLifetime, Request<?> request, byte[] responseContents, StatusLine statusLine) {
        if(DEBUG || requestLifetime > SLOW_REQUEST_THRESHOLD_MS) {
            VolleyLog.d("HTTP response for request=<%s> [lifetime=%d], [size=%s], " + "[rc=%d], [retryCount=%s]", request,
                requestLifetime, responseContents != null ? responseContents.length : "null", statusLine.getStatusCode(), request
                    .getRetryPolicy().getCurrentRetryCount());
        }
    }

    /**
     * Attempts to prepare the request for a retry. If there are no more attempts remaining in the request's retry policy, a timeout
     * exception is thrown.
