...
/**
 * Cache implementation that caches files directly onto the hard disk in the specified directory. The default disk usage size is
 * 5MB, but is configurable.
 */
public class DiskBasedCache implements Cache {
    ...
    /*
     * Homebrewed simple serialization system used for reading and writing cache headers on disk. Once upon a time, this used the
     * standard Java Object{Input,Output}Stream, but the default implementation relies heavily on reflection (even for standard
     * types) and generates a ton of garbage.
     */
