...
public class ImageRequest extends Request<Bitmap> {
    ...
    /**
     * Creates a new image request, decoding to a maximum specified width and height. If both width and height are zero, the image
     * will be decoded to its natural size. If one of the two is nonzero, that dimension will be clamped and the other one will be
     * set to preserve the image's aspect ratio. If both width and height are nonzero, the image will be decoded to be fit in the
     ...
     * @param maxPrimary Maximum size of the primary dimension (i.e. width for max width), or zero to maintain aspect ratio with
     *        secondary dimension
    ...
    /**
     * Returns the largest power-of-two divisor for use in downscaling a bitmap that will not result in the scaling past the desired
     * dimensions.
