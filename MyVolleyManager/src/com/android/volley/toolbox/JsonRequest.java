...
/**
 * A request for retrieving a T type response body at a given URL that also optionally sends along a JSON body in the request
 * specified.
...
public abstract class JsonRequest<T> extends Request<T> {
    ...
    /**
     * Deprecated constructor for a JsonRequest which defaults to GET unless {@link #getPostBody()} or {@link #getPostParams()} is
     * overridden (which defaults to POST).
