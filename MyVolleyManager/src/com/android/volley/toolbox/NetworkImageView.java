...
public class NetworkImageView extends ImageView {
    ...
    /**
     * Sets URL of the image that should be loaded into this view. Note that calling this will immediately either set the cached
     * image (if available) or the default image specified by {@link NetworkImageView#setDefaultImageResId(int)} on the view. NOTE:
     * If applicable, {@link NetworkImageView#setDefaultImageResId(int)} and {@link NetworkImageView#setErrorImageResId(int)} should
    ...
    /**
     * Gets the URL of the image that should be loaded into this view, or null if no URL has been set. The image may or may not
     * already be downloaded and set into the view.
