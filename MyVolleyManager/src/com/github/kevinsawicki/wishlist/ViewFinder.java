...
public class ViewFinder {
    ...
    /**
     * Register runnable to be invoked when child view with given id is checked/unchecked
     * @param id
     * @param runnable
     * @return view registered with runnable
     */
    ...
    /**
     * Register runnable to be invoked when all given child view ids are checked/unchecked
     * @param ids
     * @param runnable
     */
